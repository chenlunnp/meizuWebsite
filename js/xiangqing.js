...
//				xiaonav.style.display="block";
		...
		var xiangqing =main.getElementsByTagName("li");
		
		var jianjie= document.getElementById("jianjie");
		var sdiv =jianjie.getElementsByClassName("tupian");
		for(var i=0;i<xiangqing.length;i++) {
			xiangqing[i].index =i;
			xiangqing[i].onclick = function() {
				for (var i=0;i<xiangqing.length;i++) {
					xiangqing[i].className = "";
				}
				this.className="xiangqing";
				for(var j =0;j<sdiv.length;j++) {
					sdiv[j].className="tupian hide";
				}
				sdiv[this.index].className="tupian show";
			}
		}
		
		function prep() {
			var zxcv =document.getElementById("zxcv");
			var link =zxcv.getElementsByTagName("img");
